...
| **Atten-LSTM**    | **0.6199** | **0.7395** | **0.7895** | **0.8200** | **0.8376** | **0.6199** | **0.6954** | **0.7204** | **0.7335** | **0.7403** | **0.6199** | **0.6797** | **0.6964** | **0.7040** | **0.7075** |


### Tsinghua Dataset (Standard and Cold-start Split)

| Methods         | \multicolumn{5}{c}{**Standard Split**} | \multicolumn{5}{c}{**Cold Start Split**} |
|----------------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|
|               | HR@1  | HR@3  | HR@5  | MRR@3 | MRR@5 | HR@1  | HR@3  | HR@5  | MRR@3 | MRR@5 |
